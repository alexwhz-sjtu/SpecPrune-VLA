...
class OpenVLAForActionPrediction(PrismaticForConditionalGeneration):
    ...
    def _regression_or_discrete_prediction(
        ...
        **kwargs,
        ...
        skip_FFN_list = [24,25,26,27,28,29] # high attn tokens skip ffn
        # skip_FFN_list = []
        skip_ALL_list = [3,4,5,8,9]
        skip_layer_list = (skip_FFN_list, skip_ALL_list) if cfg.layer_prune else ([], []) 
        ...
        language_model_output = self.language_model(
            ...
            output_hidden_states=True,
            return_dict=True,
            skip_layer_list=([],[]) if precise_mode else skip_layer_list,
            **kwargs,
        )
        ...
        last_attn =  language_model_output.attentions
        ...
        # --------------------------------------------------------------------------------------
        # --------------------------- get layer similarity list -------------------------------

        acting_steps = kwargs["acting_steps"]
        adaptive_skip = False
        ...
        if adaptive_skip:
            ...
            # if sim_cal:
                ...
                for idx in range(0, len(language_model_output.hidden_states)):
                    
                    tmp_ahs = language_model_output.hidden_states[idx][
                        :,
                        - ACTION_DIM * NUM_ACTIONS_CHUNK - 1 : -1,
                        :,].detach()
                    
                    action_hidden_states.append(tmp_ahs)
                    if idx == 0: 
                        continue
                ...
                if len(above_threshold_indices) == 0:
                    ...
                    skip_layer_list = above_threshold_indices[topk_indices].tolist()
    ...
    def predict_action(
        ...
        **kwargs: str,
        ...
        Args:
            ...
            **kwargs includes: cfg, spec_prune(bool), acting_steps, high_similarity_indices, high_similarity_indices_wrist
        ...
        if use_diffusion:
            ...
            normalized_actions, actions_hidden_states, last_attn, skip_layer_list = self._regression_or_discrete_prediction(
                cfg,
                input_embeddings,
                all_actions_mask,
                projected_patch_embeddings,
        ...
        return actions, actions_hidden_states, last_attn, skip_layer_list
