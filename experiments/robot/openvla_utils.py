...
from .spec_prune_vla import visualize_sim_patches, visualize_layer_img_attn, get_similarity_indices, visualize_similarity_indices
...
from experiments.robot.spec_prune_constants import PRIMARY_TOPK, PRIMARY_TOPK_PRECISE, WRIST_TOPK, WRIST_TOPK_PRECISE
...
def multi_image_processing(cfg: Any, obs):
    ...
    return all_images, result_image, prev_images
    ...
    **kwargs,
    ...
    with torch.inference_mode():
        ...
        if action_head is None:
            ...
            action, _ , last_attn, skip_layer_list = vla.predict_action(
                **inputs,
                cfg=cfg,
                ...
                high_similarity_indices_wrist=high_similarity_indices_wrist,
    ...
    return [action[i] for i in range(len(action))], last_attn, one_infer, skip_layer_list
