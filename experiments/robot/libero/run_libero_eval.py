...
def run_episode(
    ...
    while t < max_steps + cfg.num_steps_wait:
        ...
        if len(action_queue) == 0:
            ...
            actions, infer_time, skip_layer_list = get_action(
                cfg,
                model,
                observation,
                task_description,
        ...
        if acting_steps >= 10:
            if cfg.action_adapter:
                ...
                if cur_velocity is not None:
                    ...
                    precise_mode = True  if cur_velocity < 0.4 or xy_velocity < 0.3 else False
                    if cur_mode == False and precise_mode:
                        if_replan = True
                    # else:
                    #     precise_mode = False if z_velocity > 0.25 else True
...
def eval_libero(cfg: GenerateConfig) -> float:
    ...
    log_message(f"layer_prune: {cfg.layer_prune}", log_file)
