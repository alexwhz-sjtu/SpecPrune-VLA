...
from .spec_prune_vla import visualize_sim_patches,visualize_layer_attn, get_similarity_indices, visualize_similarity_indices
...
from experiments.robot.spec_prune_constants import PRIMARY_TOPK, PRIMARY_TOPK_PRECISE, WRIST_TOPK, WRIST_TOPK_PRECISE, ATTN_TOPK_PRECISE, ATTN_TOPK_PRECISE_WRIST, ATTN_TOPK, ATTN_TOPK_WRIST
